...
import 'package:hello_word_2023/presentation/screen/intro_vg.dart';
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(
                height: 20), // Agrega un espacio vertical antes del botón
            MaterialButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) =>
                        const Myintrovg(), // Reemplaza TuNuevaPantalla() con la pantalla a la que deseas navegar.
                  ),
                );
              },
